...
CREATE  PROCEDURE `delete_all_recipt`(input__id VARCHAR(10))
BEGIN
DELETE FROM
  total_price_recipt
WHERE
...
After
UPDATE
  ON total_price_recipt FOR EACH ROW BEGIN 
  IF (new.r_Type = "sales") then
INSERT INTO
  outCome
VALUES(0, new.total_price,new.total_profits, MONTHNAME(NOW())) ON DUPLICATE KEY
UPDATE
...
INSERT INTO
  outCome
VALUES(new.total_price, 0,new.total_profits,  MONTHNAME(NOW())) ON DUPLICATE KEY
UPDATE
